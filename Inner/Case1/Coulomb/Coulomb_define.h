...
typedef struct tagModBus_Sent_Data_struct {	
  unsigned char 	ID;						//編號
...
}ModBus_Sent_Data_struct_define;
extern ModBus_Sent_Data_struct_define ModBus_Sent; 



typedef struct tagModBus_Receiver_Data_struct {	
  unsigned char 	ID;						//編號
  unsigned char 	Fuc;					//功能
	union
	{
	...
	unsigned char Index;						//要收資料
  unsigned char RTIndex;					//已收資料 
}ModBus_Receiver_Data_define;
extern ModBus_Receiver_Data_define ModBus_Receiver; 
